...
export default function AdminBookingHistoryPage() {
  ...
  const toCSV = () => {
    ...
    a.href = url;
    a.download = `admin-booking-history-${start}-to-${end}.csv`;
    a.click();
  ...
  const toPDF = async () => {
    ...
    const a = document.createElement('a');
    a.href = objectUrl;
    a.download = `admin-booking-history-${start}-to-${end}.pdf`;
    a.click();
  ...
  return (
    <div className="history-page">
      <div className="page-header">
        <h2>Administrator Booking History (Last 3 Months)</h2>
        <p className="subtitle">Filter and export admin bookings. Styled to match site.</p>
      </div>
      ...
      <style jsx>{`
        ...
        .page-header h2 { font-family: 'Paralucent-DemiBold', Arial, Helvetica, sans-serif; font-size: 1.8rem; color: #e50914; margin: 0 0 0.25rem 0; letter-spacing: 0.2px; }
