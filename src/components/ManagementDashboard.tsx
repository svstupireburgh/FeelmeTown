...
export default function ManagementDashboard({ stats, recentBookings, onRefresh, refreshing, lastUpdated, currentTime }: AdminDashboardProps) {
  ...
  const handleMarkAsCompleted = async (booking: Booking) => {
    const bookingId = String(
      booking.originalBookingId || (booking as any).bookingId || booking.id,
    ).replace(/^#/, '');
          ...
          <div className="dashboard-header">
            <div className="header-content">
              <div className="header-text">
                <h2>Welcome to FeelMe Town - Management Panel</h2>
                <p>Manage your bookings, theaters, and customer inquiries</p>
              </div>
              <div className="header-actions">
                {/* Reset Counters button hidden for Management */}
                {false && (
                <button
